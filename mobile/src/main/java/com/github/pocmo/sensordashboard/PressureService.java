...
public class PressureService extends Service implements SensorEventListener {
	...
	public static final String SERVICE_PRESSURE_ACTION = "com.github.pocmo.sensordashboard.PressureService";
	public static final String BROADCAST_PRESSURE_ACTION = "com.github.pocmo.sensordashboard.PressureService";
...
//			handler.postDelayed(this, 2000); // 2 seconds
			...
			//wenjing 12.16 modifiled to 1000 ms
