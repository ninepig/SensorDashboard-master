...
public class SensorFragment extends Fragment {
    ...
    public void onSensorUpdatedEvent(SensorUpdatedEvent event) {
        Log.i("wenjingInfoonSensorUpdatedEvent", "lalallalala"+event.getSensor().getName()+event.getSensor().getMaxValue());
    ...
    public void onSensorRangeEvent(SensorRangeEvent event) {
       // Log.i("wenjingInfoonSensorRangeEvent",""+event.getSensor().getName()+event.getSensor().getMaxValue());
        if (event.getSensor().getId() == this.sensor.getId()) {
            initialiseSensorData();
        }
    }
